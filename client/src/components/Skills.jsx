      ...
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p className="section-subtitle" style={{ margin: '0 auto 28px' }}>
            A broad skill set covering every layer of digital marketing — strategy, execution, and analysis.
          </p>
          <button
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
            {skills?.map(group => (
              <div key={group.category} style={{
                ...
                <h3 style={{ fontSize: '13px', fontWeight: 600, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '20px' }}>
                  {group.category}
                </h3>
