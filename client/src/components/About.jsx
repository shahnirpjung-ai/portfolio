      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <div>
            ...
            <h2 className="section-title">Turning clicks into<br />customers.</h2>
            <p style={{ color: 'var(--muted)', lineHeight: 1.8, marginBottom: '20px' }}>
              I'm a digital marketing strategist with 5+ years of experience helping businesses grow their online presence, generate leads, and scale revenue. I combine creative thinking with analytical rigor to deliver campaigns that perform.
            </p>
            <p style={{ color: 'var(--muted)', lineHeight: 1.8, marginBottom: '32px' }}>
              Whether it's architecting a paid media funnel, building an organic content engine, or running A/B tests to squeeze out every percentage point of conversion — I'm obsessed with results that move the needle.
            </p>
